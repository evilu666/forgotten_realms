...
public class JigsawPlacement {
    ...
    public static <T extends JigsawConfiguration> Optional<PieceGenerator<T>> addPieces(PieceGeneratorSupplier.Context<T> p_210285_, JigsawPlacement.PieceFactory p_210286_, BlockPos p_210287_, final int boxSize, boolean p_210288_, boolean calculateSurfaceLevel) {
            ...
            if (!predicate.test(chunkgenerator.getNoiseBiome(QuartPos.fromBlock(i), QuartPos.fromBlock(k), QuartPos.fromBlock(j)))) {
                ...
                return Optional.of((structurePiecesBuilder, context) -> {
                    ...
                    if (jigsawconfiguration.maxDepth() > 0) {
                        AABB aabb = new AABB((double)(i - boxSize), (double)(k - boxSize), (double)(j - boxSize), (double)(i + boxSize + 1), (double)(k + boxSize + 1), (double)(j + boxSize + 1));
